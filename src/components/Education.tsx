      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-8">
          {education.map((edu, index) => (
            <Card
              key={index}
              className="p-8 shadow-3d hover:shadow-3d-hover transition-all duration-500 border-border group hover:-translate-y-1 transform-gpu bg-gradient-card relative overflow-hidden"
            >
