...
export const Hero = () => {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = "/CV_Oliva-7-28-25.pdf"; 
    link.download = "CV_Oliva.pdf";
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-5xl text-center space-y-8 relative z-10">
        <div
          className={`space-y-4 transform-gpu transition-all duration-700 ${
            isVisible ? "fade-in-up" : "opacity-0"
          }`}
        >
          <h1
            className="text-5xl sm:text-6xl lg:text-7xl font-bold text-primary-foreground tracking-tight drop-shadow-2xl"
   ...
   <p className="text-xl sm:text-2xl font-semibold text-primary-foreground/50 max-w-2xl mx-auto drop-shadow-lg leading-relaxed">
  A passionate Web and Mobile Developer dedicated to transforming ideas into seamless, impactful digital experiences.
</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in duration-700 delay-150">
          ...
          <Button
            ...
            className="flex items-center gap-2 bg-primary text-white hover:bg-primary/90 shadow-3d hover:shadow-3d-hover hover:-translate-y-1 transition-all duration-300"
          >
